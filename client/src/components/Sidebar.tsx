...
import { AlignLeft, CalendarRange, CircleDot, Clock, Users, LayoutDashboard, ScrollText, LogOut, Globe, ShieldCheck, LifeBuoy } from "lucide-react";
...
const navItems = [
  ...
  { href: "/support-cases", label: "Cases", icon: LifeBuoy },
];
